<?php
/**
 * The Template for displaying all single course elements.
 *
 * Override this template by copying it to yourtheme/lucidlms/single-course-element.php
 *
 * @author        New Normal
...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<?php lucid_get_template_part( 'content', 'single-course-element' ); ?>
